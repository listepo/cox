...
| T22.3 | todo | P0 | 2 | 0% | |
| T22.4 | todo | P1 | 2 | 0% | |
| T22.6 | in progress | P1 | 2 | 0% | Claude Code / claude-sonnet-5 |
| T22.7 | todo | P1 | 1 | 0% | |
| T23.0 | todo | P1 | 2 | 0% | |
| T23.1 | todo | P1 | 2 | 0% | |
| T23.2 | todo | P1 | 2 | 0% | |
...
| `cox-tui` | TEA app, composer (tui-textarea-2 0.13, the ratatui-0.30 fork of tui-textarea 0.7), transcript cells, streaming markdown (pulldown-cmark 0.13 → spans; the plan said 0.10, same Tag/TagEnd API), syntect 5 highlighting, diff view, approval modal, status line, `/` commands, `@` file picker, `text::sanitize`, OSC 11 background detection for `tui.theme = "auto"` (T22.6) | ratatui 0.30.2, crossterm 0.29, nucleo 0.5, pulldown-cmark 0.13, syntect 5.3 (fancy-regex, no onig), unicode-width 0.2, arboard 3, terminal-colorsaurus 1.0 |
...
Model: claude-sonnet-5 · Status: in progress · Depends: — · Size: ~90 · New dependency: `terminal-colorsaurus` (needs the creator's approval and a §1.1 row) · Priority: P1 · Complexity: 2
