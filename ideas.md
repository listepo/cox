...
- Generate the Anthropic wire types (requests, content blocks, stream events) from Anthropic's published OpenAPI spec instead of hand-writing them; keep the SSE → `ProviderEvent` state machine hand-written (research pending)
